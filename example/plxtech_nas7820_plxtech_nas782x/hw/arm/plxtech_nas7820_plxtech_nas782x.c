...
#define TYPE_PLXTECH_NAS7820_PLXTECH_NAS782X "plxtech_nas7820_plxtech_nas782x"
#define PLXTECH_NAS7820_PLXTECH_NAS782X(obj) \
    OBJECT_CHECK(PLXTECH_NAS7820_PLXTECH_NAS782XState, (obj), TYPE_PLXTECH_NAS7820_PLXTECH_NAS782X)

typedef struct PLXTECH_NAS7820_PLXTECH_NAS782XState {
    ARMCPU *cpu;
...
} PLXTECH_NAS7820_PLXTECH_NAS782XState;

static void plxtech_nand_nas782x0_update(void *opaque)
{
    /* PLXTECH_NAS7820_PLXTECH_NAS782XState *s = opaque; */
}
...
static void plxtech_nas7820_plxtech_nas782x_reset(void *opaque)
{
    PLXTECH_NAS7820_PLXTECH_NAS782XState *s = opaque;
...
static void plxtech_nas7820_plxtech_nas782x_init(MachineState *machine)
{
    PLXTECH_NAS7820_PLXTECH_NAS782XState *s = g_new0(PLXTECH_NAS7820_PLXTECH_NAS782XState, 1);
    Error *err = NULL;
    ...
    memory_region_init_io(&s->plxtech_nand_nas782x0_mmio, NULL, &plxtech_nand_nas782x_ops0, s, TYPE_PLXTECH_NAS7820_PLXTECH_NAS782X, 0x100000);
    memory_region_add_subregion_overlap(get_system_memory(), 0x41000000, &s->plxtech_nand_nas782x0_mmio, 0);
    memory_region_init_io(&s->plxtech_nand_nas782x1_mmio, NULL, &plxtech_nand_nas782x_ops1, s, TYPE_PLXTECH_NAS7820_PLXTECH_NAS782X, 0x20);
    memory_region_add_subregion_overlap(get_system_memory(), 0x41c00000, &s->plxtech_nand_nas782x1_mmio, 0);
    memory_region_init_io(&s->plxtech_nas782x_ehci0_mmio, NULL, &plxtech_nas782x_ehci_ops0, s, TYPE_PLXTECH_NAS7820_PLXTECH_NAS782X, 0xf00);
    memory_region_add_subregion_overlap(get_system_memory(), 0x40200100, &s->plxtech_nas782x_ehci0_mmio, 0);
    memory_region_init_io(&s->snps_dwmac0_mmio, NULL, &snps_dwmac_ops0, s, TYPE_PLXTECH_NAS7820_PLXTECH_NAS782X, 0x2000);
    memory_region_add_subregion_overlap(get_system_memory(), 0x40400000, &s->snps_dwmac0_mmio, 0);
    memory_region_init_io(&s->plxtech_nas782x_sata0_mmio, NULL, &plxtech_nas782x_sata_ops0, s, TYPE_PLXTECH_NAS7820_PLXTECH_NAS782X, 0x20000);
    memory_region_add_subregion_overlap(get_system_memory(), 0x45900000, &s->plxtech_nas782x_sata0_mmio, 0);
    memory_region_init_io(&s->plxtech_nas782x_sata1_mmio, NULL, &plxtech_nas782x_sata_ops1, s, TYPE_PLXTECH_NAS7820_PLXTECH_NAS782X, 0x40);
    memory_region_add_subregion_overlap(get_system_memory(), 0x459a0000, &s->plxtech_nas782x_sata1_mmio, 0);
    memory_region_init_io(&s->plxtech_nas782x_sata2_mmio, NULL, &plxtech_nas782x_sata_ops2, s, TYPE_PLXTECH_NAS7820_PLXTECH_NAS782X, 0x20);
    memory_region_add_subregion_overlap(get_system_memory(), 0x459b0000, &s->plxtech_nas782x_sata2_mmio, 0);
    memory_region_init_io(&s->plxtech_nas782x_sata3_mmio, NULL, &plxtech_nas782x_sata_ops3, s, TYPE_PLXTECH_NAS7820_PLXTECH_NAS782X, 0x2000);
    memory_region_add_subregion_overlap(get_system_memory(), 0x459e0000, &s->plxtech_nas782x_sata3_mmio, 0);
    memory_region_init_io(&s->plxtech_nas782x_sata4_mmio, NULL, &plxtech_nas782x_sata_ops4, s, TYPE_PLXTECH_NAS7820_PLXTECH_NAS782X, 0xc);
    memory_region_add_subregion_overlap(get_system_memory(), 0x44900000, &s->plxtech_nas782x_sata4_mmio, 0);
    memory_region_init_io(&s->plxtech_nas782x_sata5_mmio, NULL, &plxtech_nas782x_sata_ops5, s, TYPE_PLXTECH_NAS7820_PLXTECH_NAS782X, 0x1000);
    memory_region_add_subregion_overlap(get_system_memory(), 0x50000000, &s->plxtech_nas782x_sata5_mmio, 0);
    memory_region_init_io(&s->plxtech_nas782x_pcie0_mmio, NULL, &plxtech_nas782x_pcie_ops0, s, TYPE_PLXTECH_NAS7820_PLXTECH_NAS782X, 0x10);
    memory_region_add_subregion_overlap(get_system_memory(), 0x44a00000, &s->plxtech_nas782x_pcie0_mmio, 0);
    memory_region_init_io(&s->plxtech_nas782x_pcie1_mmio, NULL, &plxtech_nas782x_pcie_ops1, s, TYPE_PLXTECH_NAS7820_PLXTECH_NAS782X, 0x1000);
    memory_region_add_subregion_overlap(get_system_memory(), 0x47c00000, &s->plxtech_nas782x_pcie1_mmio, 0);
    memory_region_init_io(&s->plxtech_nas782x_pcie2_mmio, NULL, &plxtech_nas782x_pcie_ops2, s, TYPE_PLXTECH_NAS7820_PLXTECH_NAS782X, 0x100);
    memory_region_add_subregion_overlap(get_system_memory(), 0x47d00000, &s->plxtech_nas782x_pcie2_mmio, 0);
    memory_region_init_io(&s->plxtech_nas782x_pcie3_mmio, NULL, &plxtech_nas782x_pcie_ops3, s, TYPE_PLXTECH_NAS7820_PLXTECH_NAS782X, 0x1000);
    memory_region_add_subregion_overlap(get_system_memory(), 0x47e00000, &s->plxtech_nas782x_pcie3_mmio, 0);
    memory_region_init_io(&s->plxtech_nas782x_pcie4_mmio, NULL, &plxtech_nas782x_pcie_ops4, s, TYPE_PLXTECH_NAS7820_PLXTECH_NAS782X, 0x100);
    memory_region_add_subregion_overlap(get_system_memory(), 0x47f00000, &s->plxtech_nas782x_pcie4_mmio, 0);
    memory_region_init_io(&s->plxtech_nas782x_gpio0_mmio, NULL, &plxtech_nas782x_gpio_ops0, s, TYPE_PLXTECH_NAS7820_PLXTECH_NAS782X, 0x100);
    memory_region_add_subregion_overlap(get_system_memory(), 0x44000000, &s->plxtech_nas782x_gpio0_mmio, 0);
    memory_region_init_io(&s->plxtech_nas782x_gpio1_mmio, NULL, &plxtech_nas782x_gpio_ops1, s, TYPE_PLXTECH_NAS7820_PLXTECH_NAS782X, 0x100);
    memory_region_add_subregion_overlap(get_system_memory(), 0x44100000, &s->plxtech_nas782x_gpio1_mmio, 0);
    memory_region_init_io(&s->plxtech_nas782x_gpio2_mmio, NULL, &plxtech_nas782x_gpio_ops2, s, TYPE_PLXTECH_NAS7820_PLXTECH_NAS782X, 0x200);
    memory_region_add_subregion_overlap(get_system_memory(), 0x44e00000, &s->plxtech_nas782x_gpio2_mmio, 0);
    memory_region_init_io(&s->plxtech_nas782x_gpio3_mmio, NULL, &plxtech_nas782x_gpio_ops3, s, TYPE_PLXTECH_NAS7820_PLXTECH_NAS782X, 0x200);
    memory_region_add_subregion_overlap(get_system_memory(), 0x44f00000, &s->plxtech_nas782x_gpio3_mmio, 0);
    memory_region_init_io(&s->plxtech_nas782x_pllb0_mmio, NULL, &plxtech_nas782x_pllb_ops0, s, TYPE_PLXTECH_NAS7820_PLXTECH_NAS782X, 0x10);
    memory_region_add_subregion_overlap(get_system_memory(), 0x44f001f0, &s->plxtech_nas782x_pllb0_mmio, 0);
    memory_region_init_io(&s->plxtech_nas782x_plla0_mmio, NULL, &plxtech_nas782x_plla_ops0, s, TYPE_PLXTECH_NAS7820_PLXTECH_NAS782X, 0x10);
    memory_region_add_subregion_overlap(get_system_memory(), 0x44e001f0, &s->plxtech_nas782x_plla0_mmio, 0);
    memory_region_init_io(&s->plxtech_nas782x_reset0_mmio, NULL, &plxtech_nas782x_reset_ops0, s, TYPE_PLXTECH_NAS7820_PLXTECH_NAS782X, 0x8);
...
static void plxtech_nas7820_plxtech_nas782x_machine_init(MachineClass *mc)
{
    mc->desc = "plxtech_nas7820_plxtech_nas782x";
    mc->init = plxtech_nas7820_plxtech_nas782x_init;
    mc->default_ram_size = 256 * MiB;
    mc->default_cpu_type = ARM_CPU_TYPE_NAME("arm11mpcore");
    mc->ignore_memory_transaction_failures = false;
}

DEFINE_MACHINE("plxtech_nas7820_plxtech_nas782x", plxtech_nas7820_plxtech_nas782x_machine_init)
